...
**Completed FMA Block Diagram:**  
  ![Design Schematic](DesignSchematic.jpg)
...
**Results on Torture.tv:**  
  The design failed *baby_torture.sv*. I believe this is because of the way the test vectors are built, as they use the input flags to signify add, subtract, and multiply only.
...
**Energy-Delay Product (EDP):**  
  >4.690e-3 * 2.015215 = 0.00945135835 J
  

---

## Time spent: Planning, coding, debugging, user tests, optimizing, report
Most of the work on the project was done in the last few weeks of the allotted time, due to various reasons. This semester was a one of the busiest semesters, and my inexperience in hardware design and validation on this scale led me to assume that I could complete the project in a short amount of time. Although, many modules were started beforehand, almost all parts of the project were completed in the last week.
...
## Conclusion
The FMA design was almost successfully simulated. Errors occur in the baby_torture.sv that I was unable to fix. However, the FMA passed all but one test. The faulty FMA was also able to synthesize, resulting in PPA reports for the design. Through creating the FMA, I learned more about the amount of time it takes to complete and verify hardware designs, and will use this experience to guide my organiziation of future hardware design projects.
